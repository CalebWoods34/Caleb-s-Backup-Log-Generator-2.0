...
Public Class Form1
    ...
    'function for enabling all TCs for ovens 
    Public Sub EnableAllTCsForOvens()
        TC1Box.Enabled = True
        TC2Box.Enabled = True
        TC3Box.Enabled = True
        TC4Box.Enabled = True
    ...
    'function for deleting unchecked thermocouple columns in the selected range datagridview
    Public Sub DeleteUncheckedThermocoupleColumns()
        If TC1Box.Checked = False Then
            'Columns(5).select = False
        End If
    ...
    Public Sub CheckThermocoupleCompatibility()
        ...
        End If
        If OpenFileDialog1.FileName.Contains("Oven") OrElse OpenFileDialog1.FileName.Contains("OVEN") Then
            Call EnableAllTCsForOvens()
        End If
    End Sub
End Class
